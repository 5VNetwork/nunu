...
void WindowsHostApi::SetUp(
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.nunu.WindowsHostApi.disableDNS" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.nunu.WindowsHostApi.undoDisableDNS" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.nunu.WindowsHostApi.isRunningAsAdmin" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
...
void MessageFlutterApi::NotifyShutdown(
  ...
  const std::string channel_name = "dev.flutter.pigeon.nunu.MessageFlutterApi.notifyShutdown" + message_channel_suffix_;
