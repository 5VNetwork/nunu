...
import 'package:nunu/common/const.dart';
...
const geoipUrl =
    'https://cdn.jsdelivr.net/gh/5VNetwork/process-geo@release/simplified_geoip.dat';
const geositeUrl =
    'https://cdn.jsdelivr.net/gh/5VNetwork/process-geo@release/simplified_geosite.dat';
const cnPackageIdUrl =
    'https://cdn.jsdelivr.net/gh/5VNetwork/process-geo@main/assets/cn_package_ids.txt';
...
Future<void> _fetchGeoOnce() async {
  ...
  await Future.wait([
    ...
    directDownloadToFile(cnPackageIdUrl, await getCnPackageIdFilePath()),
  ]);
