...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Failed to get nodes, your pasteboard does not contain a subscription url that Nunu can parse'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Nunu only collects diagnostic logs if the switch button below is on. These logs do not contain personal data. Please click the button below to view the detailed privacy policy.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Nunu uses the following open-source projects:'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Service is not installed. Please rerun Nunu as an administrator and start again, during which the service will be installed automatically, or change inbound mode.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'To use tun, rerun Nunu as administrator'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This uninstalls the Nunu background service. Run the app as administrator if removal fails. TUN mode can reinstall the service when you connect again.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Removing the service requires running Nunu as administrator.'**
  ...
  /// No description provided for @ruleNameNunuTestNodes.
  ///
  /// In en, this message translates to:
  /// **'Nunu Node Testing'**
  String get ruleNameNunuTestNodes;
  ...
  ///
  /// In en, this message translates to:
  /// **'Add Nunu to Windows Service'**
  String get installAsWinService;

  /// No description provided for @installAsWinServiceDesc.
  ///
  /// In en, this message translates to:
  /// **'Before use TUN, Nunu needs to be added into Windows Service. Click Yes to install Nunu as a service, which would require you to give permission in the following UAC prompt window.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Start Nunu automatically at startup'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Please enable Nunu SystemExtension by going to System Settings -> General -> Login Items & Extensions -> Network Extensions'**
  ...
  ///
  /// In en, this message translates to:
  /// **'An error occurred. Please restart Nunu. Error: {error}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Failed to insert default data, please restart Nunu and add them in the routing page. Reason: {error}'**
  ...
  /// No description provided for @welcomeToNunu.
  ///
  /// In en, this message translates to:
  /// **'Welcome to Nunu!'**
  String get welcomeToNunu;
  ...
  ///
  /// In en, this message translates to:
  /// **'Once enabled, the connection duration will be 30 minutes instead of 15 minutes. An ad will appear when you open Nunu.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Nunu cannot be used for torrenting, torrenting traffic will not go through VPN tunnels. They will be go directly to the public Internet'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Nunu uses VPNService to make your internet experience more secure, private, and stable. During the use of VPNService, we will provide you with the best server based on your IP address, and we will not share or store your IP address.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'On Android, apps with Exact type will not be handled by Nunu, they will go directly to the internet'**
