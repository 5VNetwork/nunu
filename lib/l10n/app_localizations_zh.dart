...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get privacyPolicySummary => 'Nunu只在下方按钮开启的情况下收集诊断日志，这些日志不包含您的个人数据。详细的隐私政策请点击下方按钮查看。';
  ...
  @override
  String get contactUsFreely => '如果您在使用Nunu的过程中有任何问题，请随时联系我们。';
  ...
  @override
  String get openSourceSoftwareNoticeText => 'Nunu使用了以下开源项目：';
  ...
  @override
  String get nodeChainDesc => '选中的节点将使用以下节点组成代理链。链的最后一个节点为落地节点。';
  ...
  @override
  String get startFailedReasonServiceNotInstalled => 'Service尚未安装，请以管理员身份重新运行Nunu，届时在连接过程中Service将会自动安装，或更换入站模式。';
  ...
  @override
  String get removeWindowsServiceConfirmMessage => '将卸载 Nunu 后台服务。若失败请以管理员身份运行应用。使用 TUN 连接时可能会再次自动安装服务。';

  @override
  String get removeWindowsServiceConfirm => '移除';

  @override
  String get removeWindowsServiceRequiresAdmin => '移除服务需要以管理员身份运行 Nunu。';
  ...
  @override
  String get ruleNameNunuTestNodes => 'Nunu节点测试';
  ...
  @override
  String get gfwDesc => 'GFW域名/IP使用代理，其他使用直连';

  @override
  String get cnDesc => '大陆的域名/IP使用直连，其他使用代理';
  ...
  @override
  String get installAsWinService => '添加Nunu进Windows Service';

  @override
  String get installAsWinServiceDesc => '在使用TUN前，需要将Nunu添加进Windows Service，点击“添加”以进行添加。';
  ...
  @override
  String get startOnBootDesc => '开机时自动运行Nunu';
  ...
  @override
  String get enableSystemExtension => '请前往[系统设置->通用->登录项与扩展->网络扩展]并开启 Nunu SystemExtension';
  ...
  @override
  String get nodeSetDesc => '\"__node__\"为包含所有节点域名/IP的域名小集合/IP小集合。它主要被用于让Nunu节点测试走直连。节点域名包括它的地址和SNI';
  ...
  @override
  String get ipToDomainDesc => 'IP -> Domain是最近DNS历史记录中获取的，由于许多域名可以解析到相同的IP，它可能不是实际的域名。';
  ...
  @override
  String get managePlanDesc => '更换套餐、取消订阅、重新订阅';

  @override
  String get availablePlans => '可用套餐';

  @override
  String get currentPlan => '当前套餐';

  @override
  String get dontCancelSubscription => '不取消订阅';
  ...
  @override
  String get noTokenFound => '未找到令牌';

  @override
  String get subscriptionReactivated => '订阅已重新激活';

  @override
  String get subscriptionCancelled => '订阅已取消';

  @override
  String get couldNotOpenCustomerPortal => '无法打开客户门户';

  @override
  String get noPortalUrlReceived => '未收到门户URL';

  @override
  String failedToOpenCustomerPortal(String errorMessage) {
    return '打开客户门户失败: $errorMessage';
  }

  @override
  String get couldNotOpenPlayStoreSubscriptions => '无法打开Play商店订阅';

  @override
  String get couldNotOpenAppStoreSubscriptions => '无法打开订阅管理。请前往设置 > [您的姓名] > 订阅来管理您的订阅。';

  @override
  String get cannotDeleteAccountWithActiveSubscription => '您在有活动订阅时无法删除账户。请先取消您的订阅。';

  @override
  String get visitOfficialWebsite => '访问官方网站';

  @override
  String get noPlansAvailable => '没有可用套餐';

  @override
  String get noPricingOptionsAvailable => '此套餐没有可用的价格选项';

  @override
  String get priceIdNotAvailable => '此套餐的价格ID不可用';

  @override
  String get noAuthenticationTokenFound => '未找到身份验证令牌';

  @override
  String get couldNotOpenCheckoutUrl => '无法打开结账URL';

  @override
  String get noCheckoutUrlReceived => '未收到结账URL';

  @override
  String failedToCreateCheckoutSession(String errorMessage) {
    return '创建结账会话失败: $errorMessage';
  }

  @override
  String get monthlyTraffic => '月度流量';

  @override
  String get unlimitedData => '无限流量';
  ...
  @override
  String get dataRefresh => '数据刷新';

  @override
  String get renewalDate => '续订日期';
  ...
  @override
  String get activeSubscriptionFoundMessage => '您已经有一个源自其他系统的订阅。在订阅新套餐之前，请先取消您当前的订阅。';

  @override
  String get warningExistingSubscription => '警告：现有订阅';

  @override
  String get warningExistingSubscriptionMessage => '您当前有一个已取消但尚未结束的订阅。现在订阅新套餐将导致您失去现有订阅的权益，即使它尚未结束。';

  @override
  String get loginRequired => '需要登录';

  @override
  String get loginRequiredMessage => '购买订阅前请先登录。';

  @override
  String get failedToLoadPlans => '加载套餐失败';

  @override
  String get failedToLoadPlansMessage => '请访问我们的网站查看可用套餐。';

  @override
  String get copyDatabase => '复制数据库';

  @override
  String get fromClipboard => '从剪贴板';

  @override
  String get selectQrCode => '选择二维码';
  ...
  @override
  String get perQuarter => '每季度';

  @override
  String get perHalfYear => '每半年';
  ...
  String willRenewTo(String plan, String period) {
    return '更新时套餐将变为 $plan ($period)';
  }

  @override
  String get securelyConnected => '已连接';

  @override
  String get versionTooOld => '版本过旧';

  @override
  String get versionTooOldMessage => '您的应用程序版本过旧。请升级到最新版本以继续。';
  ...
  @override
  String get welcomeToNunu => '欢迎使用 Nunu！';
  ...
  @override
  String get enableAppOpenAdsDesc => '开启后连接最大时长为 30 分钟，（而非 15 分钟）。打开Nunu时会显示广告。';

  @override
  String get noTorrect => '无法种子下载';

  @override
  String get noTorrectDesc => 'Nunu无法用于下载种子，种子下载流量不会通过Nunu隧道传输。它们的流量会直接进入到公共互联网';
  ...
  @override
  String get vpnServiceDesc => 'Nunu利用VPNService使您的上网体验更加安全，私密与稳定。在使用VPNService的过程中，我们会根据您的IP地址来为您提供最优服务器，我们不会分享或储存您的IP地址。';
  ...
  @override
  String get androidDirectAppDescription => '安卓上，精确类型的应用不会经过Nunu';
